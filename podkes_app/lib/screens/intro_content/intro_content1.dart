...
//image container
ClipRRect(borderRadius: BorderRadius.vertical(top: Radius.circular(40)),child: Image.asset('assets/images/intro1.jpg',fit: BoxFit.fill,)) ),
SizedBox(height: 100,),
...
Padding(
  ...
  //down text
  TextSpan(text: "Enjoy our music app, let's get started",style: 
